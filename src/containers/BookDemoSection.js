    ...
    <Cover>
      <Wapper>
        <div style={{ paddingLeft: "8%" }}>
          <HeadingTitle>{BookDemoData.title}</HeadingTitle>
          <QouteHeading>{BookDemoData.quote}</QouteHeading>
        </div>
        <StyledWrapper>
          <StyledText>{BookDemoData.description}</StyledText>
          <StyledButton>
            <span>{BookDemoData.buttonText}</span>
          </StyledButton>
        </StyledWrapper>
      </Wapper>
    </Cover>
